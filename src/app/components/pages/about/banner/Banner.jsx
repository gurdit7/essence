...
const Banner = () => {
  ...
  return (
    ...
    <AnimatedTextCircle/>
      ...
      <section className="overflow-hidden relative md:py-[6.25rem] py-[10vw] bg-secondary-900">
        <Container>
          <Wrapper className='mx-[-15px]'>
            <Wrapper className='px-[15px] md:max-w-[58.33333%]'>
              <h5 className="h5 text-primary mt-[.8em] max-lgl:text-[calc(1.05625rem+.675vw)]">knowledge is power</h5>
