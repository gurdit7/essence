...
const ImageAndText = () => {
  ...
  useEffect(()=>{
    pageRef?.current?.ownerDocument?.documentElement?.setAttribute('id','about-pages');
    const about = gsap.utils.toArray(".trigger-text-animation-about");
    gsap.timeline({
      scrollTrigger: {
        trigger: about[0],
        start: "top center",
  ...
  useEffect(() => {
    const panels = gsap.utils.toArray(".trigger-animation-sections-about");
  ...
  return (
    <Wrapper className="relative">
      <div ref={pageRef} className="md:max-w-[calc(83.33333%-30px)] w-full  bg-dark">
      ...
      <Wrapper className="bg-secondary-200  trigger-text-animation-about  py-[10vw] md:py-[6.25rem] trigger-animation-sections-about group">
        <Container>
          <Wrapper className="mx-[-15px]">
            <Wrapper className="px-[15px] md:max-w-[50%] w-full  duration-500 opacity-0 group-[.is-shown]:opacity-100">
      ...
      <Wrapper className="bg-secondary-200 pb-[10vw] md:pb-[6.25rem]">
        ...
        <Container>
          <Wrapper className="mx-[-15px] trigger-animation-sections-about group">
            <Wrapper className="px-[15px] md:max-w-[58.33333%] w-full">
              <Wrapper className="bg-white md:p-[3.125rem] p-[1.875rem] md:mt-[-5rem] duration-500 opacity-0 group-[.is-shown]:opacity-100">
