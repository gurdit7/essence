...
import Mockup from "../../../../../assets/images/eyes/mockup-ipad.0393440.png";
...
import Video from '../../../../../assets/videos/eyes/eyes.mp4'
  ...
  return (
    <>
      ...
      <section className="overflow-hidden relative bg-dark z-[1]" ref={pageRef}>
            ...
            <Wrapper className="overflow-hidden absolute top-0 left-0 bottom-0 right-0">
              <Image
                className={`object-cover absolute top-0 left-0 w-full h-full duration-1000 ease-cubic-22 delay-[.3s] ${
                  imageLoading ? "scale-100" : "scale-110"
                }`}
                alt="Banner Image"
                src={BannerImage.src}
                sizes="100vw"
              ...
              <Wrapper className="p-[1.875rem] md:p-[3.125rem] md:mt-[-5rem] mt-[-6.25rem] before:absolute before:content before:w-full before:top-0 before:left-0 before:h-[7.5rem] before:bg-dark">
                <Wrapper className="markdown relative z-10">
                  ...
                  <p className="text-[1rem] md:text-[1.125rem] opacity-0 duration-500 group-[.is-shown]:opacity-100 delay-100 font-normal text-white leading-[1.8]">
                    ...
                    eyes how you train, you can adjust your techniques and
                    sharpen them where necessary. With our innovative essence:
                    Eyes On system you can film your own workout. The footage is
                    uploaded to your personal environment in the essence: app.
                  </p>
                </Wrapper>
              </Wrapper>
            </Wrapper>
        ...
        <Container>
          <Wrapper className="mx-[-15px] relative z-20 group trigger-training-pts">
            <Wrapper className="w-full px-[15px]">
              <Wrapper className="relative">
                ...
                />
                <video ref={videoRef} width="320" height="240" autoPlay muted playsInline loop className="absolute w-full h-full p-[1.875rem] top-0 left-0">
        ...
        <Wrapper className="relative z-[1] imageScale-animation">
          <Wrapper className="mdm:pt-[6.25rem] pt-[10vw]">
            <Container>
                ...
                <Wrapper className="mx-[-15px]">
                  <Wrapper className="md:max-w-[41.66667%] px-[15px]">
                    ...
                    <p className="text-[1rem] duration-500 group-[.is-shown]:opacity-100 delay-100 font-normal text-white leading-[1.8]">
                      In the app you can view the footage, discuss it with your
                      trainer and use it for your own development. And just to
                      be clear: the camera is of course only on when you turn it
                      on!
                    </p>
                  </Wrapper>
                </Wrapper>
