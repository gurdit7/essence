      ...
      <section className="overflow-hidden relative" ref={pageRef}>
        ...
        <Wrapper className="md:w-[calc(83.33333%-30px)]">
          ...
          >
            ...
            <Image
              className={`object-cover absolute top-0 left-0 w-full h-full duration-1000 ease-cubic-22 ${imageLoading ? 'scale-100' : 'scale-[1.1]'}`}
              alt="Banner Image"
              src={BannerImage.src}
              sizes="100vw"
                ...
                <Wrapper className="markdown">
                  <p className="text-[1rem] md:text-[1.125rem] opacity-0 duration-500 group-[.is-shown]:opacity-100 delay-75 font-normal text-black leading-[1.8]">
                    <strong>
                      ...
                      our evidence-based approach, success is assured. The
                      result is the healthiest, fittest, strongest and best
                      version of yourself.
                    </strong>
                  </p>
                  <p className="text-[1rem] md:text-[1.125rem] opacity-0 duration-500 group-[.is-shown]:opacity-100 delay-100 font-normal text-black leading-[1.8]">
                    ...
                    better and better about yourself. Are you optimally fit?
                    Then you will feel a lot better physically and mentally.
                  </p>
                </Wrapper>
              </Wrapper>
            </Wrapper>
