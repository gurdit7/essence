    ...
    <>
      <section className="py-[10vw] md:py-[6.25rem] relative overflow-hidden">
        ...
        <Container className="max-w-[1280px] w-full mx-auto relative z-10">
          ...
          <Wrapper className="mx-[-15px] flex flex-wrap mdm:mt-[-13.75rem] mt-[-1.875rem] make-animation-trigger-pts group">
            <Wrapper className="md:max-w-[50%]  md:ml-[8.33333%] px-[15px] w-full">
              <Wrapper className="image-wrapper relative">
                <Wrapper
                  className="
            ...
            <Wrapper className="md:ml-[8.33333%] w-full md:max-w-[33.33333%] px-[15px]">
              ...
              <h2 className="text-primary leading-none font-bold text-[4.375rem] max-sm-tab:text-[.9375rem]">
