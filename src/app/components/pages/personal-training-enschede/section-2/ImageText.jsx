...
import PersonalTrainingSecondImage from "../../../../assets/images/personal-training-enschede/personal-training_2.jpg";
import PersonalTrainingFirstImage from "../../../../assets/images/personal-training-enschede/personal-training_1_large.jpg";
          ...
          <Wrapper className="mx-[-15px] flex flex-wrap mdm:mt-[-13.75rem] mt-[-1.875rem] max-sm-tab:mt-0 make-animation-trigger-pts group">
           ...
           <span className="translate-y-[110%] block duration-500 group-[.is-shown]:translate-y-[0%]">
              ...
              <p className="max-sm-tab:text-base opacity-0 delay-75 duration-500 translate-y-[20%] group-[.is-shown]:translate-y-[0%] group-[.is-shown]:opacity-100">
                Would you like to train with us? Then we will start working
                seriously for and with you. We also ask that commitment from
                you. We provide you with tailor-made solutions and personal
                guidance. You provide the hard work and perseverance.
              </p>
            </Wrapper>
          </Wrapper>
        </Container>
