...
import PersonalTrainingSecondImage from "../../../../assets/images/Home/essence-personal-training-2.jpg";
import PersonalTrainingFirstImage from "../../../../assets/images/Home/essence-personal-training.jpg";
...
const ImageText = () => {
  ...
  useEffect(() => {
    ...
    const animationImages = gsap.utils.toArray(".trigger-animation-images");
    gsap.timeline({
      scrollTrigger: {
        trigger: animationImages[0],
        start: "top center",
        end: "bottom 80%",
        scrub: 1,
        markers: false,
        onEnter: ({ progress, direction, isActive }) => {
          setBgColor("bg-primary");
          animationImages[0].classList.add("is-shown");
        },
        onLeaveBack: ({ progress, direction, isActive }) => {
          setBgColor("bg-[#f8f8f8]");
        },
    ...
    const circle = gsap.timeline({
      scrollTrigger: {
        trigger: ".trigger-animation-images",
        start: `top center`,
        end: `bottom center`,
        scrub: 1,
        markers: false,
    ...
    circle.to(".teaser-circle__icon svg", { rotation: 180 });

    const animationLinks = gsap.utils.toArray(".trigger-animation-links");
    gsap.timeline({
      scrollTrigger: {
        trigger: animationLinks[0],
        start: "top center",
        end: "bottom 80%",
        scrub: 1,
        markers: false,
        onEnter: ({ progress, direction, isActive }) => {
          setBgColor("bg-[#f8f8f8]");
          animationLinks[0].classList.add("is-shown");
        },
        onLeaveBack: ({ progress, direction, isActive }) => {
          setBgColor("bg-primary");
        },
    ...
    <section className="pt-[10vw] md:pt-[6.25rem] relative overflow-hidden">
      ...
      <Container className="max-w-[1280px] w-full mx-auto trigger-animation-section-2 group relative z-10">
        <Wrapper className="mx-[-15px] flex flex-wrap">
          <Wrapper className="md:max-w-[41.66667%] md:ml-[16.66667%] px-[15px] w-full">
          ...
          <Wrapper className="md:max-w-[33.33333%] ml-[16.66667%] md:ml-[8.33333%] px-[15px] w-full">
            <p className="pt-[3.125rem] md:pt-[9.375rem] mb-[1rem] max-sm-tab:text-base">
            Have you been planning for some time to actually do some sports? Then essence is: the studio to get the best start. With a personal program that suits you exactly.

            </p>
          </Wrapper>
        </Wrapper>
      </Container>
      <Container className='max-sm-tab:px-0'>
        <Wrapper className="mx-[-15px] flex flex-wrap mt-[4.6875rem] items-center md:justify-end trigger-animation-images group">
          <Wrapper className="md:max-w-[41.66667%] max-w-[75%] px-[15px] w-full">
          ...
          <Wrapper className="md:max-w-[50%] hidden md:block px-[15px] w-full">
            <Wrapper
      ...
      <Container className='py-[6.25rem] trigger-animation-links group'>
        <Wrapper className="mx-[-15px] flex flex-wrap">
          <Wrapper className="md:max-w-[91.66667%] md:mt-[8.33333%] md:ml-[8.33333%] px-[15px] w-full">
            <ul>
