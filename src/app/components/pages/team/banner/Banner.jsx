            ...
            <Wrapper className="mx-[-15px]">
              <Wrapper className="px-[15px] max-w-[50%]">
                <p className="text-[1rem] md:text-[1.125rem]  delay-100 font-normal text-white leading-[1.8]">
                  Everyone has their own reason for registering with Fitlab.
      ...
      <Wrapper className='pointer-events-none'>
        <Wrapper className="overflow-hidden">
          <span
            ...
            className={
              item.strokeColor +
              " member-card__title lowercase  text-[4.375rem] group-[.is-shown]:translate-y-[0%] delay-700 leading-none block duration-500 translate-y-[100%] font-bold "
            }
          >
            Member
          </span>
        ...
        <Wrapper className="overflow-hidden">
          <span
            data-text={item?.name}
            className="member-card__title lowercase text-primary text-[4.375rem] leading-none block group-[.is-shown]:translate-y-[0%] delay-700 duration-500 translate-y-[100%] font-bold"
          >
            {item?.name}
          </span>
        </Wrapper>
